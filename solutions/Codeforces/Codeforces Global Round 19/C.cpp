        ...
        if (p.second == 0)
            ...
            if (p.first == 0) {
                if (n - 2 == sum || p.second == 1)
                    cout << "-1\n";
                else cout << ceil((double) (sum - n % 2) / 2) + ceil((double) p.second / 2) << "\n";
            } else {
...
//                    } else {
//                        cout << ceil((double) (sum - 2)/2) + (p.second - 2)/2 + 2 << "\n";
//                    }
//                } else {
//                    cout << ceil((double) (sum - 1)/2) + (p.second - 1)/2 + 1 << "\n";
//                }
            }
        }
    }
